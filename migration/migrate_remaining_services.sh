...
# Script to migrate remaining services to z-grid namespace

SERVICES=("ban-service-yavar" "format-service-yavar" "jail-service-yavar" "gibberish-service-yavar" "tox-service-yavar")
...
echo "Service migration configurations created. Applying to cluster..."
