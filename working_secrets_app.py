...
app = FastAPI(title="Secrets Detection Service", version="1.0.0")
...
PATTERNS_DIR = os.getenv("PATTERNS_DIR", "secrets_service/patterns")
...
MIN_TOKEN_LEN = int(os.getenv("MIN_TOKEN_LEN","20"))
CONTEXT_WINDOW_CHARS = int(os.getenv("CONTEXT_WINDOW_CHARS","40"))
